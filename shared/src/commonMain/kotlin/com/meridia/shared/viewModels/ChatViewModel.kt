...
import com.meridia.shared.network.auth.SessionRepository
import com.meridia.shared.network.chat.ChatRepository
            ...
            .onSuccess { assistantText ->
                ...
                if (isFirstMessage) {
                    ...
                    runCatching { 
                        ...
                        val sessionSpecificRepo = com.meridia.shared.network.auth.SessionRepositoryImpl(initialSession.token.accessToken)
